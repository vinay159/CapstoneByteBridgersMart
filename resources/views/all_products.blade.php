...
{{--    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.bundle.min.js" rel="stylesheet">--}}
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="{{  asset('css/inline_tailwind.css') }}">
    <!-- Bootstrap icons-->
                    ...
                    <g transform="matrix(1,0,0,1,-0.6060606060606801,-0.4308396658437914)">
                        <svg viewBox="0 0 396 117" data-background-color="#28353b" preserveAspectRatio="xMidYMid meet"
                            ...
                            <g id="tight-bounds" transform="matrix(1,0,0,1,0.24000000000003752,0.17087539289397569)">
                                <svg viewBox="0 0 395.5199999999999 116.65824921421208" height="116.65824921421208"
                                    ...
                                    <g>
                                        <svg viewBox="0 0 657.2295342277798 193.84922834467253"
                                            ...
                                            <g>
                                                <svg viewBox="0 0 225.2443971942581 193.84922834467253"
                                                     height="193.84922834467253" width="225.2443971942581">
                                                    <g>
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                             x="0" y="0"
                                                             viewBox="8 12.986999999999998 85.99989647571269 74.013"
                                                             enable-background="new 0 0 100 100" xml:space="preserve"
                                                             height="193.84922834467253" width="225.2443971942581"
                                                             class="icon-icon-0" data-fill-palette-color="accent"
                                                             id="icon-0"><path
                                                                d="M23.149 49.139c-5.409 0-9.808 4.4-9.808 9.808s4.399 9.808 9.808 9.808c5.407 0 9.807-4.4 9.807-9.808S28.556 49.139 23.149 49.139zM23.149 65.646c-3.695 0-6.701-3.006-6.701-6.7s3.006-6.7 6.701-6.7c3.693 0 6.699 3.006 6.699 6.7S26.842 65.646 23.149 65.646z"
                                                                fill="#ff2d20" data-fill-palette-color="accent"></path>
                                                            <path
                                                                d="M80.293 25.135c-0.58-0.24-1.248-0.108-1.693 0.335l-6.641 6.633c-3.059-2.404-6.461-4.307-10.162-5.673-0.805-0.297-1.697 0.114-1.994 0.918-0.299 0.806 0.113 1.699 0.918 1.996 3.273 1.208 6.291 2.879 9.018 4.973l-8.971 8.96c-0.445 0.444-0.576 1.112-0.338 1.692 0.24 0.581 0.807 0.988 1.436 0.988L79.684 46c0.002 0 0.002 0 0.002 0 0.412 0 0.807-0.191 1.098-0.482s0.455-0.7 0.455-1.112l0.012-17.827C81.25 25.95 80.873 25.376 80.293 25.135zM78.133 42.835l-12.516-0.009 12.523-12.507L78.133 42.835z"
                                                                fill="#ff2d20" data-fill-palette-color="accent"></path>
                                                            <path
                                                                d="M17.585 43.525c0.259 0.167 0.549 0.246 0.835 0.246 0.513 0 1.014-0.252 1.311-0.716 3.48-5.432 8.423-9.771 14.293-12.547 0.776-0.367 1.107-1.293 0.74-2.069-0.366-0.775-1.292-1.106-2.067-0.74-6.399 3.025-11.787 7.756-15.582 13.681C16.652 42.102 16.863 43.063 17.585 43.525z"
                                                                fill="#ff2d20" data-fill-palette-color="accent"></path>
                                                            <path
                                                                d="M49.184 26.381C48.856 26.241 49 26.101 48 25.963v-7.104c2 0.551 1.973 1.594 2.01 1.672 0.362 0.771 1.398 1.107 2.176 0.751 0.779-0.357 0.94-1.28 0.581-2.06C52.706 19.088 52 16.303 48 15.584v-1.044c0-0.858-0.642-1.553-1.499-1.553-0.858 0-1.501 0.695-1.501 1.553v0.997c-3 0.539-5.572 2.827-5.572 5.932 0 2.818 2.572 4.841 5.572 6.439v9.147c-2-0.539-3.581-2.24-4.092-3.049-0.458-0.727-1.322-0.943-2.048-0.484-0.726 0.458-1.084 1.417-0.625 2.143C38.851 36.643 41 39.588 45 40.21v1.322c0 0.858 0.643 1.554 1.501 1.554 0.857 0 1.499-0.695 1.499-1.554v-1.33c4-0.642 6.241-3.634 6.241-6.543C54.241 31.105 53.962 28.439 49.184 26.381zM45 24.321c-1-1.04-2.466-1.994-2.466-2.852 0-1.372 1.466-2.367 2.466-2.759V24.321zM48 37.038v-7.671c3 1.372 3.012 2.667 3.012 4.292C51.012 34.797 51 36.482 48 37.038z"
                                                                fill="#ff2d20" data-fill-palette-color="accent"></path>
                                                            <path
                                                                d="M93.986 47.428c-0.109-0.85-0.885-1.448-1.74-1.339l-2.732 0.357c-0.562 0.074-1.039 0.447-1.246 0.975l-2.625 6.718L55.631 55.25c-0.434 0.018-0.842 0.215-1.125 0.545-0.283 0.331-0.412 0.766-0.359 1.197l1.654 13.5c0.09 0.73 0.678 1.299 1.41 1.359l22.57 1.898c0.49 0.547 1.182 1.262 2.137 2.249 1.186 1.224 1.332 1.95 1.232 2.188-0.189 0.444-1.289 0.896-2.182 0.896-1.912 0-24.238 0.137-24.463 0.139-0.859 0.006-1.551 0.541-1.545 1.398C54.967 81.475 55.66 82 56.514 82h0.01c0.227 0 22.543 0.025 24.445 0.025 1.551 0 4.174-0.662 5.043-2.71 0.488-1.155 0.562-3.019-1.861-5.52-1.064-1.095-1.678-1.736-2.031-2.127l8.709-22.272 1.82-0.232C93.5 49.053 94.1 48.279 93.986 47.428zM79.207 70.584L58.73 68.862l-1.295-10.569 26.879-0.996L79.207 70.584z"
                                                                fill="#ff2d20" data-fill-palette-color="accent"></path>
                                                            <circle cx="59.805" cy="84.845" r="1.7" fill="#ff2d20"
                                                                    data-fill-palette-color="accent"></circle>
                                                            <circle cx="83.668" cy="84.845" r="1.7" fill="#ff2d20"
                                                                    data-fill-palette-color="accent"></circle>
                                                            <path
                                                                d="M32.288 70H14.475C10.798 70 8 73.041 8 76.717v8.906C8 86.48 8.504 87 9.362 87h28.038C38.258 87 39 86.48 39 85.623v-8.906C39 73.041 35.962 70 32.288 70zM36 84h-4v-5.387c0-0.857-0.642-1.553-1.5-1.553S29 77.756 29 78.613V84H18v-5.387c0-0.857-0.643-1.553-1.501-1.553-0.857 0-1.499 0.695-1.499 1.553V84h-4v-7.283C11 74.755 12.512 73 14.475 73h17.813C34.25 73 36 74.755 36 76.717V84z"
                                                                fill="#ff2d20" data-fill-palette-color="accent"></path></svg>
                                                    </g>
                                                </svg>
                                            </g>
                                        </svg>
                                ...
                                <rect width="395.5199999999999" height="116.65824921421208" fill="none" stroke="none"
